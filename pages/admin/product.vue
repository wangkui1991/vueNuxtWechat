...
export default {
  ...
  methods: {
    ...
    async deleteProduct (item) {
      await this.$store.dispatch('product/deleteProduct', item)
    },
    createProduct () {
      this.edited = {
        images: [],
    ...
    async saveEdited () {
      this.isProduct ? await this.$store.dispatch('product/putProduct', this.edited) : await this.$store.dispatch('product/saveProduct', this.edited)
      console.log('d', this.edited)
...
<style type="text/css" lang='sass' src='../../static/sass/admin.sass'></style>
