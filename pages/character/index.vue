...
.container
  ...
  .focusCharacters-body
    ...
    .focusCharacter-stills
      img(v-for='item in character.images', :src="imageCDN + item + '?imageView2/1/w/750/h/460/format/jpg/q/80|imageslim'")
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      character: state => state.vuessr.focusCharacter
    })
  },
  beforeCreate () {
    let id = this.$route.query.id
    this.$store.dispatch('vuessr/focusCharacter', id)
  }
}
</script>
